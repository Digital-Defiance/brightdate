...
describe('ExactBrightDate', () => {
  ...
  describe('epoch()', () => {
    ...
    it('converts to 2000-01-01T12:00:00.000Z', () => {
      expect(ExactBrightDate.epoch().toISO()).toBe('2000-01-01T12:00:00.000Z');
    });
  });
  ...
  describe('fromISO', () => {
    it('J2000 ISO string maps to epoch', () => {
      expect(
  ...
  describe('addNanoseconds', () => {
    it('adding 1000 ns equals adding 1 us', () => {
      ...
      expect(
        e.addNanoseconds(1000n).equals(e.addMicroseconds(1n)),
      ).toBe(true);
    });
  });
  ...
  describe('addMilliseconds', () => {
    it('1 ms of picoseconds is 1_000_000_000', () => {
      expect(
        ExactBrightDate.epoch().addMilliseconds(1n).picoseconds,
      ).toBe(1_000_000_000n);
    });
  ...
  describe('toBrightDateValue (lossy bridge)', () => {
    ...
    it('Unix epoch maps to -10957.5', () => {
      expect(ExactBrightDate.fromUnixMs(0).toBrightDateValue()).toBe(-10957.5);
    });
  });
