...
describe("BrightDate class", () => {
  ...
  describe("BrightDate.fromUnixSeconds()", () => {
    it("converts Unix seconds to BrightDate", () => {
      expect(BrightDate.fromUnixSeconds(J2000_UNIX_MS_UTC / 1000).value).toBe(
        0,
      );
    });
  });
  ...
  describe("BrightDate.fromISO()", () => {
    it("parses an ISO string", () => {
      expect(BrightDate.fromISO("2000-01-01T11:58:55.816Z").value).toBe(0);
    });
  ...
  describe("toISO()", () => {
    it("returns ISO string for epoch", () => {
      expect(BrightDate.epoch().toISO()).toBe("2000-01-01T11:58:55.816Z");
    });
  });
  ...
  describe("addMicrodays()", () => {
    it("adds microdays", () => {
      expect(BrightDate.fromValue(0).addMicrodays(500_000).value).toBeCloseTo(
        0.5,
        6,
      );
    });
  ...
  describe("addMinutes()", () => {
    it("adds minutes", () => {
      expect(BrightDate.fromValue(0).addMinutes(720).value).toBeCloseTo(0.5, 8);
    });
  });
  ...
  describe("compareTo()", () => {
    it("returns -1 when this < other", () => {
      expect(BrightDate.fromValue(1).compareTo(BrightDate.fromValue(2))).toBe(
        -1,
      );
    });

    it("returns 1 when this > other", () => {
      expect(BrightDate.fromValue(2).compareTo(BrightDate.fromValue(1))).toBe(
        1,
      );
    });

    it("returns 0 when equal", () => {
      expect(BrightDate.fromValue(5).compareTo(BrightDate.fromValue(5))).toBe(
        0,
      );
    });
  });
  ...
  describe("equals()", () => {
    it("returns true for equal values", () => {
      expect(BrightDate.fromValue(5).equals(BrightDate.fromValue(5))).toBe(
        true,
      );
    });
  ...
  describe("isBefore() / isAfter()", () => {
    it("isBefore returns true when this < other", () => {
      expect(BrightDate.fromValue(1).isBefore(BrightDate.fromValue(2))).toBe(
        true,
      );
    });

    it("isAfter returns true when this > other", () => {
      expect(BrightDate.fromValue(2).isAfter(BrightDate.fromValue(1))).toBe(
        true,
      );
    });

    it("isBefore returns false when equal", () => {
      expect(BrightDate.fromValue(5).isBefore(BrightDate.fromValue(5))).toBe(
        false,
      );
    });
  });
